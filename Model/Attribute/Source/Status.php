 ...
 */
namespace Innovadeltech\Wishlist\Model\Attribute\Source;
...
/**
 * Class Status
 * @package Innovadeltech\Wishlist\Model\Attribute\Source
 */
class Status extends AbstractSource implements SourceInterface, OptionSourceInterface
{
    ...
    {
        return [self::STATUS_CHECKED => __('Yes'), self::STATUS_UNCHECKED => __('No')];
    }
