 ...
 */
class ManagementActions extends Column
{
    /** Url path */
    const MANAGEMENT_URL_PATH_EDIT = 'wishlist/management/edit';
    const MANAGEMENT_URL_PATH_DELETE = 'wishlist/management/delete';
    const MANAGEMENT_URL_PATH_NOTIFY = 'wishlist/management/notify';
    ...
    public function __construct(
        ...
        array $components = [],
        array $data = [],
        $editUrl = self::MANAGEMENT_URL_PATH_EDIT,
        $notifyUrl = self::MANAGEMENT_URL_PATH_NOTIFY
    ) {
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as &$item) {
                ...
                if (isset($item['id'])) {
                    ...
                    $item[$name]['delete'] = [
                        'href' => $this->_urlBuilder->getUrl(self::MANAGEMENT_URL_PATH_DELETE, ['id' => $item['id']]),
                        'label' => __('Delete'),
                        'confirm' => [
